...
public class ManufacturerController {
    ...
    public void POST_PCs(@RequestParam(required = false) String name,@RequestParam(required = false) String productId, @RequestParam(required = false) String energyClass, @RequestParam(required = false) String dimensions, @RequestParam(required = false) String lifecycle, @RequestParam(defaultValue = "0") int powerRating, @RequestParam(required = false) String installingInstructions, @RequestParam(required = false) String maintenanceInstructions, @RequestParam(required = false) String repairInstructions, @RequestParam(required = false) String assemblyCarbonFootprint, @RequestParam(required = false) String warranty, @RequestParam(required = false) String componentType, @RequestParam(required = false) String componentId, @RequestParam(required = false) String componentName){
        manufacturerService.addPC(name, productId, energyClass, dimensions, lifecycle, powerRating, installingInstructions, maintenanceInstructions, repairInstructions, assemblyCarbonFootprint, warranty, componentType, componentId, componentName);
    }
    ...
    public void updatePC(@PathVariable Long id, @RequestParam(required = false) String name, @RequestParam(required = false) String productId, @RequestParam(required = false) String energyClass, @RequestParam(required = false) String dimensions, @RequestParam(required = false) String lifecycle, @RequestParam(defaultValue = "0") int powerRating, @RequestParam(required = false) String installingInstructions, @RequestParam(required = false) String maintenanceInstructions, @RequestParam(required = false) String repairInstructions, @RequestParam(required = false) String assemblyCarbonFootprint, @RequestParam(required = false) String warranty, @RequestParam(defaultValue = "0") int idForComponent, @RequestParam(required = false) String componentType, @RequestParam(required = false) String componentId, @RequestParam(required = false) String componentName) {
        manufacturerService.updatePCField(id, name, productId, energyClass, dimensions, lifecycle, powerRating, installingInstructions, maintenanceInstructions, repairInstructions, assemblyCarbonFootprint, warranty, idForComponent, componentType, componentId, componentName);
